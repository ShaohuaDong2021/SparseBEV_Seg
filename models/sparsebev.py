...
class SparseBEV(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        gt bboxes 3d, ground truth boxes
        Args:
        ...
        """
        # use the head (original, just detection)
        # outs = self.pts_bbox_head(pts_feats, img_metas)
        # loss_inputs = [gt_bboxes_3d, gt_labels_3d, outs]
        # losses = self.pts_bbox_head.loss(*loss_inputs)

        # use the multi-task head
        outs = self.pts_bbox_head(pts_feats, img_metas)
    ...
    def forward_train(self,
        ...
        losses = self.forward_pts_train(img_feats, gt_bboxes_3d, gt_labels_3d, img_metas, semantic_indices, gt_bboxes_ignore)
