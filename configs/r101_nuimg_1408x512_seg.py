_base_ = ['./r50_nuimg_704x256_seg.py']
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'semantic_indices'], meta_keys=(
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', keys=['img', 'semantic_indices'], meta_keys=(
